...
namespace VM_ediaAPI.Migrations
{
    ...
    [Migration("20210605204904_AddedTags")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VM_ediaAPI.Models.PostTag", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VM_ediaAPI.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("VM_ediaAPI.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("VM_ediaAPI.Models.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
